...
final class RegisterViewController: UIViewController {
    ...
    private let firstNameField: UITextField = {
        ...
        field.borderActiveColor = .systemPurple
        field.borderInactiveColor = .black
       field.placeholderColor = .black
        field.placeholderFontScale = 1
        field.placeholder = "First Name"
      //  field.attributedPlaceholder = NSAttributedString(string: "Placeholder Text", attributes: [
  ...
  //      field.backgroundColor = .secondarySystemBackground
   ...
   //     field.backgroundColor = .secondarySystemBackground
    ...
    private let registerButton: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 0.8196, green: 0.5176, blue: 1, alpha: 1.0)
