...
class MainViewController: UIViewController {
    ...
    var categoryArray: [CategoryModel] = [CategoryModel(title: "Requests", icon: #imageLiteral(resourceName: "twitterlogo"), indicatorOn: false), CategoryModel(title: "Pending", icon: #imageLiteral(resourceName: "instagram logobest"), indicatorOn: false), CategoryModel(title: "Friends", icon: #imageLiteral(resourceName: "tripleGopher"), indicatorOn: false)]
