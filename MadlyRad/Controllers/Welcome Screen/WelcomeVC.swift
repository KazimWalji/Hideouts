...
class WelcomeVC: UIViewController {
    ...
    let welcomePages = [
        WelcomePage(imageName: "Logo-Light", topicText: "Hideouts", descriptionText: "The ultimate app for your bad days. Here are some of our key fetures!"),
        WelcomePage(imageName: "message_icon", topicText: "Chat", descriptionText: "Contact your friends by sending them text, audio or media messages."),
        WelcomePage(imageName: "image_icon", topicText: "Shaking Cool", descriptionText: "Shake your phone to see pictures of sentiment!"),
    ...
    override func viewDidLoad() {
       ...
       // view.backgroundColor = .white
        ...
        backgroundImage.image = UIImage(named: "welcomepagedownload.png")
    ...
    @objc private func animateLogoLabel(){
        ...
        UIView.animate(withDuration: 0.5, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0, options: .curveEaseIn, animations: {
            label.transform = .identity
             ...
             let controller = ChatTabBar()//SignIn()
