...
class SignInView: UIView {
    ...
    private func setupLoginView() {
        ...
        var height: CGFloat = 220 //added 20
        if controller.view.frame.height > 1000 { height = 420 } //added 20
        
        //hurr: changed bottom anchor from -150 to -180
        let constraints = [
            bottomAnchor.constraint(equalTo: controller.view.bottomAnchor, constant: -180),
